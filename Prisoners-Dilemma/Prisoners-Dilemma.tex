...
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|>{\raggedleft\arraybackslash}p{15em}|r|>{\raggedleft\arraybackslash}p{10em}|>{\raggedleft\arraybackslash}p{10em}}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{1}{c|}{Always Cooperate} & \multicolumn{1}{c|}{Always Defect} & \multicolumn{1}{c|}{Tit for Tat} & \multicolumn{1}{c|}{Tit for Two Tats} & \multicolumn{1}{c|}{Tit for Tat with Forgiveness} & \multicolumn{1}{c|}{Tit for Tat with Randomisation} & \multicolumn{1}{c|}{Random} & \multicolumn{1}{c|}{Grim/Trigger} & \multicolumn{1}{c|}{Pavlov} & \multicolumn{1}{c|}{Prober} & \multicolumn{1}{c|}{Bully} & \multicolumn{1}{c|}{Bounded Random Strategy} & \multicolumn{1}{c|}{Gradient Cooperation} & \multicolumn{1}{c|}{Total} & \multicolumn{1}{c}{Rank} \\
\cline{2-2} \cline{3-3} \cline{4-4} \cline{5-5} \cline{6-6} \cline{7-7} \cline{8-8} \cline{9-9} \cline{10-10} \cline{11-11} \cline{12-12} \cline{13-13} \cline{14-14} \cline{15-15} \cline{16-16}
Always Cooperate & 150 & 0 & 150 & 150 & 150 & 150 & 66 & 150 & 150 & 150 & 36 & 150 & 150 & 1602 & 10\\
\hline
\cellcolor{gray!10}{Always Defect} & \cellcolor{gray!10}{250} & \cellcolor{gray!10}{50} & \cellcolor{gray!10}{54} & \cellcolor{gray!10}{58} & \cellcolor{gray!10}{82} & \cellcolor{gray!10}{54} & \cellcolor{gray!10}{158} & \cellcolor{gray!10}{54} & \cellcolor{gray!10}{54} & \cellcolor{gray!10}{250} & \cellcolor{gray!10}{98} & \cellcolor{gray!10}{54} & \cellcolor{gray!10}{250} & \cellcolor{gray!10}{\textbf{1466}} & \cellcolor{gray!10}{\textbf{13}}\\
\hline
Tit for Tat & 150 & 49 & 150 & 150 & 150 & 150 & 107 & 150 & 150 & 150 & 85 & 150 & 150 & \textbf{1741} & \textbf{5}\\
\hline
\cellcolor{gray!10}{Tit for Two Tats} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{48} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{95} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{73} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{\textbf{1716}} & \cellcolor{gray!10}{\textbf{6}}\\
\hline
Tit for Tat with Forgiveness & 150 & 46 & 150 & 150 & 150 & 150 & 95 & 150 & 150 & 150 & 72 & 150 & 150 & \textbf{1713} & \textbf{7}\\
\hline
\cellcolor{gray!10}{Tit for Tat with Randomisation} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{49} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{119} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{85} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{\textbf{1753}} & \cellcolor{gray!10}{\textbf{3}}\\
\hline
Random & 206 & 24 & 112 & 168 & 128 & 114 & 114 & 26 & 31 & 202 & 65 & 113 & 212 & \textbf{1515} & \textbf{12}\\
\hline
\cellcolor{gray!10}{Grim/Trigger} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{49} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{145} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{97} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{\textbf{1791}} & \cellcolor{gray!10}{\textbf{2}}\\
\hline
Pavlov & 150 & 49 & 150 & 150 & 150 & 150 & 153 & 150 & 150 & 150 & 97 & 150 & 150 & \textbf{1799} & \textbf{1}\\
\hline
\cellcolor{gray!10}{Prober} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{93} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{36} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{\textbf{1629}} & \cellcolor{gray!10}{\textbf{8}}\\
\hline
Bully & 226 & 38 & 90 & 138 & 97 & 90 & 150 & 42 & 42 & 226 & 74 & 85 & 226 & \textbf{1524} & \textbf{11}\\
\hline
\cellcolor{gray!10}{Bounded Random Strategy} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{49} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{113} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{81} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{150} & \cellcolor{gray!10}{\textbf{1743}} & \cellcolor{gray!10}{\textbf{4}}\\
\hline
Gradient Cooperation & 150 & 0 & 150 & 150 & 150 & 150 & 75 & 150 & 150 & 150 & 36 & 150 & 150 & \textbf{1611} & \textbf{9}\\
\hline
\end{tabular}}
\end{table}
