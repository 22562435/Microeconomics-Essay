...
strategies <- list(
    ...
    Tit_for_Tat_with_Forgiveness=tit_for_tat_forgiveness,
    Tit_for_Tat_with_Randomisation=tit_for_tat_randomisation,
    Random = random_strategy,
    Grim_Trigger=grim_trigger,
    Pavlov = pavlov,
    Prober=prober,
    Bully= bully,
    Bounded_Random_Strategy=bounded_random_strategy,
    Gradient_Cooperation =gradient_cooperation
)
