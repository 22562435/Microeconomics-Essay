...
```{r}
set.seed(100)
symmetric_results <- tournament_payoff_df(strategies,rounds = 200)
...
```{r}
set.seed(100)
symmetric_results <- tournament_payoff_df(strategies,rounds = 2)
...
```{r}
set.seed(420)
result_df <- ranking_matrix_for_sequence_p(strategies, rounds = 2, rank = TRUE)
...
```
```{r}
ranking_matrix_for_sequence_p(strategies, rounds = 10, rank = FALSE)
```

```{r}
ranking_matrix_for_sequence_p(strategies, rounds = 1, rank = FALSE)
```


```{r}
tournament_payoff_df(strategies, rounds =1)
```


```{r}

df200roundsp0<-tournament_payoff_df(strategies, rounds =200)
...
```{r}
check<-ranking_matrix_for_sequence_p(strategies, rounds = 50, rank =TRUE)
checkvalues<-ranking_matrix_for_sequence_p(strategies, rounds = 50, rank =FALSE)
